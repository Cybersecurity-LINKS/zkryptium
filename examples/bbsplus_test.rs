...
fn main() {
    ...
    let mut keygen = VecDeque::<Duration>::with_capacity(100);
    let mut sign_gen = VecDeque::<Duration>::with_capacity(100);
    let mut sign_verify = VecDeque::<Duration>::with_capacity(100);
    let mut proof_gen = VecDeque::<Duration>::with_capacity(100);
    let mut proof_verify = VecDeque::<Duration>::with_capacity(100);
    let mut sign_update = VecDeque::<Duration>::with_capacity(100);
