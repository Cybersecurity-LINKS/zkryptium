...
use crate::{utils::{message::CL03Message, random::random_bits, util::divm}, schemes::algorithms::CL03, schemes::generics::Commitment};
...
impl NISPSecrets {
    pub(crate) fn nisp2sec_generate_proof<CS>(message: &CL03Message, commitment: &CL03Commitment, g1: &Integer, h1: &Integer, n1: &Integer) -> Self
    where
        CS: CLCiphersuite,
        CS::HashAlg: Digest
    {
    ...
    pub(crate) fn nisp2sec_verify_proof<CS>(&self, commitment: &CL03Commitment, g1: &Integer, h1: &Integer, n1: &Integer) -> bool
    where
        CS: CLCiphersuite,
        CS::HashAlg: Digest
    {
