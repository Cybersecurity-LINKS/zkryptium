...
use crate::{keys::{pair::KeyPair, cl03_key::CL03CommitmentPublicKey}, schemes::algorithms::{CL03Sha256, Scheme, CL03, Ciphersuite}, bbsplus::message::CL03Message, cl03::ciphersuites::CLSha256, signatures::{signature::Signature, commitment::Commitment, proof::ZKPoK}};
    ...
    <S::Ciphersuite as Ciphersuite>::HashAlg: Digest
{
    ...
    let cl03_keypair = KeyPair::<CL03<S::Ciphersuite>>::generate(Some(2));
