...
#[cfg(test)]
mod cl03_tests {
    use crate::{cl03::tests::{signature, zkpok, blind_sign, spok, update_signature}, schemes::algorithms::CL03Sha256};
    ...
    //Signature Proof of Knowledge - SHA256
    #[test]
    fn spok_sha256() {
        spok::<CL03Sha256>();
    }
